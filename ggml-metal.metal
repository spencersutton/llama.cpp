...
kernel void kernel_mul_mat_q5_K_f32(
    ...
    for (int i = tpitg.x; i < nb; i += tptg.x) {
        ...
        sc1 = as_type<uchar2>((uint16_t)(a[0] & kmask1));
        sc2 = as_type<uchar2>((uint16_t)(a[2] & kmask1));
        sc3 = as_type<uchar2>((uint16_t)(((a[4] >> 0) & kmask2) | ((a[0] & kmask3) >> 2)));
        sc4 = as_type<uchar2>((uint16_t)(((a[4] >> 4) & kmask2) | ((a[2] & kmask3) >> 2)));
