...
kernel void kernel_mul_mat_q2_K_f32(
    ...
    for (int i = tpitg.y; i < nb; i += tptg.y) {
        ...
        for (int l = 0; l < 4; ++l) {
            sumf += y[l + 0] * (dall * d[0] * ((q[l] >> 0) & 3) - dmin * m[0]) + y[l + 16] * (dall * d[1] * ((q[l] >> 2) & 3) - dmin * m[1]) + y[l + 32] * (dall * d[2] * ((q[l] >> 4) & 3) - dmin * m[2]) + y[l + 48] * (dall * d[3] * ((q[l] >> 6) & 3) - dmin * m[3]);
        }
    }
#endif
...
kernel void kernel_mul_mat_q3_K_f32(
    ...
    for (int i = tpitg.y; i < nb; i += tptg.y) {
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            sumf += y[l + 0] * d1 * ((int8_t) ((q[l + 0] >> 0) & 3) - ((hm & 0x01) ? 0 : 4)) + y[l + 16] * d2 * ((int8_t) ((q[l + 0] >> 2) & 3) - ((hm & 0x04) ? 0 : 4)) + y[l + 32] * d3 * ((int8_t) ((q[l + 0] >> 4) & 3) - ((hm & 0x10) ? 0 : 4)) + y[l + 48] * d4 * ((int8_t) ((q[l + 0] >> 6) & 3) - ((hm & 0x40) ? 0 : 4));
        }
    }
...
kernel void kernel_mul_mat_q4_K_f32(
    ...
    for (int i = tpitg.y; i < nb; i += tptg.y) {
        ...
        for (int l = 0; l < 4; ++l) {
            sumf += d * scales[0] * (y[l + 0] * (q[l] & 0xF) + y[l + 16] * (q[l + 16] & 0xF)) - m * scales[2] * (y[l + 0] + y[l + 16]) + d * scales[1] * (y[l + 32] * (q[l] >> 4) + y[l + 48] * (q[l + 16] >> 4)) - m * scales[3] * (y[l + 32] + y[l + 48]);
        }
    }
#endif
...
kernel void kernel_mul_mat_q5_K_f32(
    ...
    for (int i = tpitg.y; i < nb; i += tptg.y) {
        ...
        for (int l = 0; l < 4; ++l) {
            ...
            sumf += y[l + 0] * d * s[0] * ((q[l + 0] & 0xF) - (hl & 0x01 ? 0 : 16)) + y[l + 16] * d * s[1] * ((q[l + 16] & 0xF) - (hl & 0x04 ? 0 : 16)) + y[l + 32] * d * s[2] * ((q[l + 0] >> 4) - (hl & 0x10 ? 0 : 16)) + y[l + 48] * d * s[3] * ((q[l + 16] >> 4) - (hl & 0x40 ? 0 : 16));
        }
    }
#endif
    sum[ith] = sumf;
