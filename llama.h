...
llama_init_from_file(const char *path_model,
...
LLAMA_API void llama_set_kv_cache(struct llama_context *ctx,
                                  const uint8_t *kv_cache, size_t n_size,
                                  int n_token_count);
...
LLAMA_API const char *llama_token_to_str(struct llama_context *ctx,
                                         llama_token token);
...
LLAMA_API llama_token llama_sample_top_p_top_k(
    struct llama_context *ctx, const llama_token *last_n_tokens_data,
    int last_n_tokens_size, int top_k, float top_p, float temp,
